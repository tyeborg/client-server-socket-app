...
![GitHub last commit](https://img.shields.io/github/last-commit/tyeborg/client-server-socket-app)
...
* **Robustness**: `Good` (Program handles almost all erroneous or unexpected input gracefully without surprising the user)
